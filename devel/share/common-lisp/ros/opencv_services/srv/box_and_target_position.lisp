...
(cl:defmethod box_id-val ((m <box_and_target_position-request>))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<box_and_target_position-request>)))
  ...
  "24f75c68c4ed789ee1229b48052db0b6")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'box_and_target_position-request)))
  "Returns md5sum for a message object of type 'box_and_target_position-request"
  "24f75c68c4ed789ee1229b48052db0b6")
...
(cl:defmethod width-val ((m <box_and_target_position-response>))
...
(cl:defmethod height-val ((m <box_and_target_position-response>))
...
(cl:defmethod angle-val ((m <box_and_target_position-response>))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<box_and_target_position-response>)))
  ...
  (cl:format cl:nil "geometry_msgs/Point box_position  # Response: 3D position of the box~%geometry_msgs/Point target_position  # Response: 3D position of the target~%float32 width  # Width of the bounding box~%float32 height  # Height of the bounding box~%float32 angle  # Angle of the bounding box~%~%~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'box_and_target_position-response)))
  "Returns full string definition for message of type 'box_and_target_position-response"
  (cl:format cl:nil "geometry_msgs/Point box_position  # Response: 3D position of the box~%geometry_msgs/Point target_position  # Response: 3D position of the target~%float32 width  # Width of the bounding box~%float32 height  # Height of the bounding box~%float32 angle  # Angle of the bounding box~%~%~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
