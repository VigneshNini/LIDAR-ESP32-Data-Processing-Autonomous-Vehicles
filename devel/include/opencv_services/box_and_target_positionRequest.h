...
bool operator==(const ::opencv_services::box_and_target_positionRequest_<ContainerAllocator1> & lhs, const ::opencv_services::box_and_target_positionRequest_<ContainerAllocator2> & rhs)
{
...
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::opencv_services::box_and_target_positionRequest_<ContainerAllocator>& v)
  {
    s << indent << "box_id: ";
